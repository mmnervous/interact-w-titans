...
start_len ft_truncate(char *buffer, int delimiter, int x) // this function calculate where to start and the len of the return
{
	int		j;
	int		k;
...
int main(int argc, char *argv[])
{
  ...
  sprintf(int_getBalance, "{\"jsonrpc\":\"2.0\",\"method\":\"int_getBalance\",\"params\":[\"%s\", \"latest\"],\"id\":1}", argv[1]);
